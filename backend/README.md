...
## Project Structure
    ...
    ├── billowing_tooth_dev_81447  # Django project configurations
...
1. Clone this repo and `cd billowing_tooth_dev_81447`
...
2. Clone this repo and `cd billowing_tooth_dev_81447`
